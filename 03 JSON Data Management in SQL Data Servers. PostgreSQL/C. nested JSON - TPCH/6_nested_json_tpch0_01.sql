		...
		select orders.*,
			(select to_jsonb(array_agg(to_jsonb(y)))
			 from (
	        	select *
    	    	from lineitem temp
        		where temp.l_orderkey = orders.o_orderkey			 
			 ) y
			) as lineitem
		from orders ) x ;
			...
			(select to_jsonb(array_agg(to_jsonb(y)))
			 from (
        		...
        		where customer.c_custkey = 
					CAST (json_data ->> 'o_custkey' AS integer) 	 
			 ) y
			) as orders
		from customer ) x
...
/*
 DROP SCHEMA IF EXISTS tpch0_01__2019032701024 CASCADE ; 
-- CREATE SCHEMA tpch0_01__2019032701024; 
-- path1: lineitem_orders_customer_nation_region
-- conn_1_2: ~
...
CREATE TABLE tpch0_01__2019032701024.lineitem_orders_customer_nation_region AS 
...
CREATE TABLE tpch0_01__2019032701024.lineitem_partsupp_part AS 
...
CREATE TABLE tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region AS 
...
ALTER TABLE tpch0_01__2019032701024.lineitem_orders_customer_nation_region ADD CONSTRAINT lineitem_orders_customer_nation_region_pkey PRIMARY KEY (l_orderkey, l_linenumber) ; 
ALTER TABLE tpch0_01__2019032701024.lineitem_partsupp_part ADD CONSTRAINT lineitem_partsupp_part_pkey PRIMARY KEY (l_orderkey, l_linenumber) ; 
ALTER TABLE tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region ADD CONSTRAINT lineitem_partsupp_supplier_nation_region_pkey PRIMARY KEY (l_orderkey, l_linenumber) ; 


ALTER TABLE tpch0_01__2019032701024.lineitem_orders_customer_nation_region ADD CONSTRAINT lineitem_orders_customer_nation_region_l_orderkey_fkey FOREIGN KEY (l_orderkey, l_linenumber)  REFERENCES tpch0_01__2019032701024.lineitem_partsupp_part (l_orderkey, l_linenumber) ; 
ALTER TABLE tpch0_01__2019032701024.lineitem_partsupp_part ADD CONSTRAINT lineitem_partsupp_part_l_orderkey_fkey FOREIGN KEY (l_orderkey, l_linenumber)  REFERENCES tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region (l_orderkey, l_linenumber) ; 



CREATE TABLE tpch0_01__2019032701024.lineitem_orders_customer_nation_region__JSON_FLAT AS SELECT row_number() over () AS id, to_jsonb(x) AS json_data FROM tpch0_01__2019032701024.lineitem_orders_customer_nation_region x ;

CREATE TABLE tpch0_01__2019032701024.lineitem_partsupp_part__JSON_FLAT AS SELECT row_number() over () AS id, to_jsonb(x) AS json_data FROM tpch0_01__2019032701024.lineitem_partsupp_part x ;

CREATE TABLE tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region__JSON_FLAT AS SELECT row_number() over () AS id, to_jsonb(x) AS json_data FROM tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region x ;



CREATE TABLE tpch0_01__2019032701024.lineitem_orders_customer_nation_region__JSON_NESTED AS SELECT row_number() over () AS id, to_jsonb(x) AS json_data FROM tpch0_01__2019032701024.lineitem_orders_customer_nation_region x ;

CREATE TABLE tpch0_01__2019032701024.lineitem_partsupp_part__JSON_NESTED AS SELECT row_number() over () AS id, to_jsonb(x) AS json_data FROM tpch0_01__2019032701024.lineitem_partsupp_part x ;

CREATE TABLE tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region__JSON_NESTED AS SELECT row_number() over () AS id, to_jsonb(x) AS json_data FROM tpch0_01__2019032701024.lineitem_partsupp_supplier_nation_region x ;
