...
--=========================================================================================
-- 		03 for database `sales`, within the same (sub)schema, two series of JSON tables 
-- 					will be created, one `flat` and one type of nested JSON
--=========================================================================================
