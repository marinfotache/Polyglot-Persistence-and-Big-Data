...
// 2. Create a project called `project_transportation`
// 3. Enter the project `project_transportation`
// 4. Create a database (Local Graph) called `transportation2025` (pay attention to the password)
// 5. Start (make active) the database `transportation2025`
