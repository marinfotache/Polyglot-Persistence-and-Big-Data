...
//  See previous script (`06-02a...`) for sub-schema/graph creation and administration



//##########################  		 			 		   ############################
//### 			Next statements (ended in ";") must be launched one by one in browser
//###
//###  In Neoj browser it is impossible to launch more than one query at a time
//###
...
//#	Display just two nodes refering to cities of Iasi and Bacau
...
MATCH (city:City) -[rel:IS_IN_COUNTY]->(county:County)
RETURN city.cityName, rel, county.countyName
ORDER BY county.countyName, city.cityName
